...
##### Result
```
 {"jsonrpc":"2.0","id":42,"result":"Version dev ()\nCompiled at  using Go go1.18.3 (arm64)"}
```
...
##### Result
```
 {"jsonrpc":"2.0","id":42,"result":"0x1b84adea42d5b7d192fd8a61a85b25abe0757e9a65cab1da470258914053823f"}
```
...
#### Parameters
- DATA, The signed transaction data to send.
